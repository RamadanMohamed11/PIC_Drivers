...
# 14 "ECU/LCD/../../MCAL/GPIO/hal_gpio.h"
...
# 12 "ECU/LCD/../../MCAL/GPIO/../std_types.h"
# 1 "ECU/LCD/../../MCAL/GPIO/../compiler.h" 1
# 12 "ECU/LCD/../../MCAL/GPIO/../std_types.h" 2

# 1 "ECU/LCD/../../MCAL/GPIO/../std_libraries.h" 1
# 12 "ECU/LCD/../../MCAL/GPIO/../std_libraries.h"
...
# 12 "ECU/LCD/../../MCAL/GPIO/../std_libraries.h" 2
...
# 52 "ECU/LCD/../../MCAL/GPIO/hal_gpio.h"
typedef enum
{
    GPIO_LOW,
    GPIO_HIGH
...
Std_ReturnType lcd_4bit_initialize(const lcd_4bit_t* lcd_4bit)
{
    ...
    else
    {
        ...
        for(uint8 local_index=0; local_index<4; local_index++)
        {
        ...
        state &= lcd_send_higher_nibble(lcd_4bit, 0x38);
        _delay((unsigned long)((5)*(8000000/4000.0)));
        state &= lcd_send_higher_nibble(lcd_4bit, 0x38);
        _delay((unsigned long)((150)*(8000000/4000000.0)));
        state &= lcd_send_higher_nibble(lcd_4bit, 0x38);
        state &= lcd_send_higher_nibble(lcd_4bit, 0x28);

        state &= lcd_4bit_send_command(lcd_4bit, 0x28);
        state &= lcd_4bit_send_command(lcd_4bit, 0x01);
        state &= lcd_4bit_send_command(lcd_4bit, 0x02);
        state &= lcd_4bit_send_command(lcd_4bit, 0x0c);
        state &= lcd_4bit_send_command(lcd_4bit, 0x06);
# 73 "ECU/LCD/ecu_lcd.c"
    }
    return state;
}
...
Std_ReturnType lcd_4bit_send_command(const lcd_4bit_t* lcd_4bit, const uint8 command)
{
    ...
    else
    {
        ...
        state &= lcd_send_4bits(lcd_4bit,command >> 4);
...
Std_ReturnType lcd_4bit_send_char_data(const lcd_4bit_t* lcd_4bit, const uint8 ch)
{
    ...
    else
    {
        ...
        state &= lcd_send_4bits(lcd_4bit,ch >> 4);
        state &= lcd_4bit_send_enable_signal(lcd_4bit);
...
{
    Std_ReturnType state = (Std_ReturnType)1;
    if(lcd_4bit == ((void*)0) || row > 4 || col > 80)
    {
        state = (Std_ReturnType)0;
    }
    else
...
{
    Std_ReturnType state = (Std_ReturnType)1;
    if(lcd_4bit == ((void*)0) || row > 4 || col > 80 || str == ((void*)0))
    {
        state = (Std_ReturnType)0;
    }
    else
...
Std_ReturnType lcd_4bit_send_custome_char(const lcd_4bit_t* lcd_4bit, const uint8 row, const uint8 col, const char* str, uint8 mem_pos)
{
    ...
    {
        state &= lcd_4bit_send_command(lcd_4bit, 0x40 + (mem_pos * 8));
...
Std_ReturnType lcd_4bit_set_position(const lcd_4bit_t* lcd_4bit, uint8 row, uint8 col)
{
    ...
    else
    {
        ...
        {
            case 1:
                state &= lcd_4bit_send_command(lcd_4bit, (0x80 + col));
                break;
            case 2:
                state &= lcd_4bit_send_command(lcd_4bit, (0xC0 + col));
                break;
            case 3:
                state &= lcd_4bit_send_command(lcd_4bit, (0x94 + col));
                break;
            case 4:
                state &= lcd_4bit_send_command(lcd_4bit, (0xD4 + col));
                break;
        }
    }
    return state;
...
Std_ReturnType lcd_8bit_initialize(const lcd_8bit_t* lcd_8bit)
{
    ...
    else
    {
        ...
        _delay((unsigned long)((20)*(8000000/4000.0)));
        state &= lcd_8bit_send_command(lcd_8bit, 0x38);
        _delay((unsigned long)((5)*(8000000/4000.0)));
        state &= lcd_8bit_send_command(lcd_8bit, 0x38);
        _delay((unsigned long)((150)*(8000000/4000000.0)));
        state &= lcd_8bit_send_command(lcd_8bit, 0x38);

        state &= lcd_8bit_send_command(lcd_8bit, 0x01);
        state &= lcd_8bit_send_command(lcd_8bit, 0x02);
        state &= lcd_8bit_send_command(lcd_8bit, 0x0c);
        state &= lcd_8bit_send_command(lcd_8bit, 0x06);
    }
    return state;
}
...
{
    Std_ReturnType state = (Std_ReturnType)1;
    if(lcd_8bit == ((void*)0) || row > 4 || col > 80)
    {
        state = (Std_ReturnType)0;
    }
    else
...
{
    Std_ReturnType state = (Std_ReturnType)1;
    if(lcd_8bit == ((void*)0) || row > 4 || col > 80 || str == ((void*)0))
    {
        state = (Std_ReturnType)0;
    }
    else
...
Std_ReturnType lcd_8bit_send_custome_char(const lcd_8bit_t* lcd_8bit, const uint8 row, const uint8 col, const char* str, uint8 mem_pos)
{
    ...
    {
        state &= lcd_8bit_send_command(lcd_8bit, 0x40 + (mem_pos * 8));
        for(uint8 local_index=0; local_index<8; local_index++)
        {
...
Std_ReturnType lcd_8bit_set_position(const lcd_8bit_t* lcd_8bit, uint8 row, uint8 col)
{
    ...
    else
    {
        ...
        {
            case 1:
                state &= lcd_8bit_send_command(lcd_8bit, (0x80 + col));
                break;
            case 2:
                state &= lcd_8bit_send_command(lcd_8bit, (0xC0 + col));
                break;
            case 3:
                state &= lcd_8bit_send_command(lcd_8bit, (0x94 + col));
                break;
            case 4:
                state &= lcd_8bit_send_command(lcd_8bit, (0xD4 + col));
                break;
        }
    }
    return state;
...
{
    Std_ReturnType state = (Std_ReturnType)1;
    if(lcd_4bit == ((void*)0)) return (Std_ReturnType)0;
    ...
    state &= lcd_send_4bits(lcd_4bit, data >> 4);
    state &= lcd_4bit_send_enable_signal(lcd_4bit);
    return state;
}
