...
#define INTERRUPT_ENABLE_UNMASKED_INTERRUPT() (INTCONbits.GIE = 1)
#define INTERRUPT_DISABLE_UNMASKED_INTERRUPT() (INTCONbits.GIE = 0)

#define INTERRUPT_ENABLE_UNMASKED_PERIPHERAL_INTERRUPT() (INTCONbits.PEIE = 1)
#define INTERRUPT_DISABLE_UNMASKED_PERIPHERAL_INTERRUPT() (INTCONbits.PEIE = 0)
